...
public class Dashboard {
    ...
    private void updateTelemetry() {
        ...
        // getAlliance() is empty until the DS reports one, which in simulation
        // may be never. .get() would throw here every loop.
        boolean red = DriverStation.getAlliance().orElse(Alliance.Blue) == Alliance.Red;
        WBfieldMap.sendPose(red ? 16.0-pose.getY() : pose.getY(), pose.getX(), pose.getRotation().getDegrees());
