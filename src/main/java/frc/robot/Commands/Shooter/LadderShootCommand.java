...
public class LadderShootCommand extends Command {
    // Real Variables
    ...
    public void execute() {
        ...
        // } else {
            this.shooter.setHoodAngle(90-(Math.pow(0.475086, 3.06-4.67884)+62+(-1.37205*3.06)));
            this.shooter.setRPS((1.456*(3.06-2.0) + 51));
